...
public class Theme {
    ...
    private Theme(Context c) {
        ...
        */
        mThemes.add(new ThemeDescriptor(0, R.style.AppTheme_Pixel, false, R.string.theme_light, false));
        mThemes.add(new ThemeDescriptor(1, R.style.AppTheme_Dark2, true, R.string.theme_dark, false));
