package com.installer.apkinstaller.installerx.resolver.appmeta.apks;
        ...
        try {
            ...
            for (ApkSourceFile.Entry entry : apkSourceFile.listEntries()) {
                ...
                if (entry.getLocalPath().equals(SaiExportedAppMeta.META_FILE)) {
                    ...
                    File iconFile = Utils.createTempFileInCache(mContext, "InstallerAPKZipAppMetaExtractor", "png");
                    if (iconFile == null)
                        continue;
